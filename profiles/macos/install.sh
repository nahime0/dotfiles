...
apply_git_patch "$DOTFILES_ROOT/config/tmux/patches/tmux-pane-tree-compact-single-pane.patch" "$HOME/.config/tmux/plugins/tmux-pane-tree"
apply_git_patch "$DOTFILES_ROOT/config/tmux/patches/tmux-pane-tree-compact-pane-focus.patch" "$HOME/.config/tmux/plugins/tmux-pane-tree"
apply_git_patch "$DOTFILES_ROOT/config/tmux/patches/tmux-pane-tree-selection-refresh.patch" "$HOME/.config/tmux/plugins/tmux-pane-tree"
